...
// Function to generate a 6-digit random string
const generateUsername = () => {
    return Math.random().toString(36).substring(2, 8);
}

// Get or create the username for this session
const getUsername = () => {
...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>Guru Gpt </h1>
                            <p>Start a conversation and explore the power of Guru AI.</p>
                        </div>`
